...
import { Loader2, TrendingUp, Plus, Activity, ArrowUpRight, Download, Github, RefreshCw, Bot, Globe, Zap, MessageSquare } from "lucide-react";
...
export default function DashboardPage({ stats, chatbots, loading, canCreateChatbot, onCreateChatbot }: DashboardPageProps) {
  if (loading) {
    return (
