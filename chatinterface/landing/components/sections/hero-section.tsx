    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-20 relative">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-4 max-w-xl mx-auto">
          <div className="w-full flex flex-col sm:flex-row items-center gap-3 p-2 rounded-2xl bg-zinc-900/50 border border-zinc-800 focus-within:border-zinc-700 transition-all">
            <div className="flex-1 w-full px-3 flex items-center gap-2">
              <ExternalLink className="w-4 h-4 text-zinc-500" />
              <Input
                placeholder="https://yourwebsite.com"
                className="border-0 bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 text-zinc-200"
              />
            </div>
