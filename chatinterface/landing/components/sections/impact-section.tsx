const metrics = [
  { value: "Under 10s", label: "Build Time", description: "From URL to Chatbot" },
  { value: "95%+", label: "Accuracy", description: "AI Knowledge Base" },
  { value: "24/7", label: "Automated Support", description: "Always on for customers" },
  { value: "1-Line", label: "Integration", description: "Simple script embed" },
]
